/* SHADOWED FILE CHANGES
 *
 * Changed the icon from `paint.svg` to `format.svg`
 * Organised imports (prettier)
 */
...
// CUSTOM IMPORTS
import iconSVG from '@plone/volto/icons/format.svg';
...
const StyleMenuButton = ({ icon, active, ...props }) => {
  return <ToolbarButton {...props} icon={icon} active={active} />;
};
